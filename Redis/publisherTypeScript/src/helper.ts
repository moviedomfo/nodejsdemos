...
export class Helper {
  ...
  */
  ...
  public static Log(message: string, setDate:boolean=true): void {
    try{
      const logFileName = Helper.getFileNamePrefix() + "logs.txt";
      let log ='';
      if(setDate===true){
        log = Helper.getTime_Iso() + ' INFO ';
  ...
  public static GetTime():string{
    ...
    const data = DateTime.fromISO(dt_local.toString()).toFormat("HH:mm:ss");
